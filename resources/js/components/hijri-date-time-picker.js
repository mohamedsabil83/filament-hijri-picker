...
export default (Alpine) => {
    Alpine.data(
        ...
        ({ displayFormat, firstDayOfWeek, isAutofocused, isDisabled, locale, shouldCloseOnDateSelection, state }) => {
            ...
            return {
                ...
                init: function () {
                    ...
                    let date = this.getSelectedDate() ?? dayjs().tz(timezone).hour(0).minute(0).second(0);
                ...
                setDisplayText: function () {
                    this.displayText = this.getSelectedDate()
                        ? this.getSelectedDate().locale(locale).format(displayFormat)
                        : '';
                },
